        ...
        <form method="post" action="<?php echo U();?>">
            <table cellspacing="1" cellpadding="3" width="100%">
                    ...
                    <td>
                        ...
                        <input type="text" name="name" value="<?php echo ((isset($row["name"]) && ($row["name"] !== ""))?($row["name"]):''); ?>" >                        <span class="require-field">*</span>
                    </td>
                </tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="bottom" value="<?php echo ((isset($row["bottom"]) && ($row["bottom"] !== ""))?($row["bottom"]):''); ?>" >                        <span class="require-field">*</span>
                    </td>
                </tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="top" value="<?php echo ((isset($row["top"]) && ($row["top"] !== ""))?($row["top"]):''); ?>" >                        <span class="require-field">*</span>
                    </td>
                </tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="discount" value="<?php echo ((isset($row["discount"]) && ($row["discount"] !== ""))?($row["discount"]):''); ?>" >                        <span class="require-field">*</span>
                    </td>
                </tr>
                    ...
                    <td>
                        ...
                        <textarea name="intro" style="resize: none" cols="40" rows="6"><?php echo ((isset($row["intro"]) && ($row["intro"] !== ""))?($row["intro"]):''); ?></textarea>
                    ...
                    <td>
                        ...
                        <input type="text" name="sort" value="<?php echo ((isset($row["sort"]) && ($row["sort"] !== ""))?($row["sort"]):20); ?>" >                        <span class="require-field">*</span>
                    </td>
                </tr>

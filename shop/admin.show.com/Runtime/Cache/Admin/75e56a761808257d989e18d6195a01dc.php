...
<head>
    ...
    <link href="http://admin.show.com/Public/Admin/css/page.css" rel="stylesheet" type="text/css"/>
    
    <link href="http://admin.show.com/Public/Admin/jquery-treegrid/css/jquery.treegrid.css" rel="stylesheet" type="text/css"/>
    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1" class="tree">
            ...
            <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr class="treegrid-<?php echo ($row["id"]); ?> <?php if(($row["level"]) != "1"): ?>treegrid-parent-<?php echo ($row["parent_id"]); endif; ?>">
                    ...
                    <td align="center"><a class="ajax-get" href="<?php echo U('changeStatus',array('id'=>$row['id'],'status'=>1-$row['status']));?>"><img src="http://admin.show.com/Public/Admin/images/<?php echo ($row["status"]); ?>.gif"/></a></td>
                    <td align='center'><?php echo ($row["sort"]); ?></td>
                    <td align="center">
...
<script type="text/javascript" src="http://admin.show.com/Public/Admin/js/common.js"></script>
    ...
    <script type="text/javascript" src="http://admin.show.com/Public/Admin/jquery-treegrid/js/jquery.treegrid.js"></script>

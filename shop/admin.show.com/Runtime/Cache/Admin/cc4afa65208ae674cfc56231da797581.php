...
<div class="form-div">
    ...
    <form action="<?php echo U('index');?>" name="searchForm">
        <img src="http://admin.show.com/Public/Admin/images/icon_search.gif" width="26" height="22" border="0" alt="search"/>
    ...
    <div class="list-div" id="listDiv">
        ...
        <table cellpadding="3" cellspacing="1">
            <tr>
                <th width="40px">序号<input type="checkbox" class="all" /></th>
                <th> 分类名称 </th>
                <th> 是否帮助 </th>
                <th> 简介 </th>
                <th> 状态 </th>
            ...
            <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td align='center'><?php echo ($row['is_help']==1?'是':'否'); ?></td>
